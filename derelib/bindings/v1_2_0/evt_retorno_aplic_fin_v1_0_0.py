...
__NAMESPACE__ = "http://www.dere.gov.br/schemas/evtRetornoAplicFin/v1_0_0"
...
class DeRe(DereMixin):
    ...
    :ivar evtRetornoAplicFin: Retorno do evento Identificação de Aplicações
        Financeiras.
    :ivar signature:
    """
    ...
    class Meta:
        name = "DeRE"
        namespace = "http://www.dere.gov.br/schemas/evtRetornoAplicFin/v1_0_0"

    evtRetornoAplicFin: DeRe.EvtRetornoAplicFin = field(
        metadata={
            "type": "Element",
        }
    )
    ...
    class EvtRetornoAplicFin:
        ...
        ideContrib: DeRe.EvtRetornoAplicFin.IdeContrib = field(
            metadata={
                "type": "Element",
            }
        )
        ideStatus: DeRe.EvtRetornoAplicFin.IdeStatus = field(
            metadata={
                "type": "Element",
            }
        )
        infoRecEv: DeRe.EvtRetornoAplicFin.InfoRecEv = field(
            metadata={
                "type": "Element",
            }
        )
        infoEvento: None | DeRe.EvtRetornoAplicFin.InfoEvento = field(
            default=None,
            metadata={
                "type": "Element",
            },
        ...
        class IdeStatus:
            ...
            ocorrencias: list[DeRe.EvtRetornoAplicFin.IdeStatus.Ocorrencias] = field(
        ...
        class InfoEvento:
            ...
            :ivar infoTotAplicFin: Informações de totalizadores do evento D-1106
                - Aplicações Financeiras {evtAplicResTec}.
            """

            idePeriodo: DeRe.EvtRetornoAplicFin.InfoEvento.IdePeriodo = field(
                metadata={
                    "type": "Element",
                }
            )
            infoAdic: None | DeRe.EvtRetornoAplicFin.InfoEvento.InfoAdic = field(
                default=None,
                metadata={
                    "type": "Element",
                },
            ...
            infoTotAplicFin: (
                None | DeRe.EvtRetornoAplicFin.InfoEvento.InfoTotAplicFin
            ) = field(
                default=None,
                metadata={
                    "type": "Element",
            ...
            @dataclass(kw_only=True)
            class InfoTotAplicFin:
                """
                :ivar vApurTot: Somatório de todas as ocorrências de {vApur} do
                    evento D-1106 ({evtAplicResTec}). Cálculo: SOMA({vApur})
                """
