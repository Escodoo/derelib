...
__NAMESPACE__ = "http://www.dere.gov.br/schemas/evtServRemTarifa/v0_0_1"
...
class QualifOperIndPresenc(Enum):
    """
    :cvar VALUE_0: Não (serviço prestado de forma remota, eletrônica ou online)
    :cvar VALUE_1: Sim (serviço fruído presencialmente)
    """
...
class DeRe(DereMixin):
    ...
    :ivar evtServRemTarifa: Evento de identificação e detalhamento de tarifas.
        Validação: Evento exclusivo e obrigatório para o registro de operações
        cujos códigos de base de cálculo ({codBC}) correspondam a um dos
        seguintes valores: [4210].
    :ivar signature:
    """

    class Meta:
        name = "DeRE"
        namespace = "http://www.dere.gov.br/schemas/evtServRemTarifa/v0_0_1"

    evtServRemTarifa: DeRe.EvtServRemTarifa = field(
        metadata={
            "type": "Element",
        }
    )
    ...
    class EvtServRemTarifa:
        ...
        ideEvento: DeRe.EvtServRemTarifa.IdeEvento = field(
            metadata={
                "type": "Element",
            }
        )
        ideContrib: DeRe.EvtServRemTarifa.IdeContrib = field(
            metadata={
                "type": "Element",
            }
        )
        idePeriodo: DeRe.EvtServRemTarifa.IdePeriodo = field(
            metadata={
                "type": "Element",
            }
        )
        infoOper: DeRe.EvtServRemTarifa.InfoOper = field(
            metadata={
                "type": "Element",
            }
        )
        ...
        class InfoOper:
            ...
            gOper: list[DeRe.EvtServRemTarifa.InfoOper.GOper] = field(
            ...
            class GOper:
                ...
                :ivar codBC: Código identificador da base de cálculo, conforme
                    ...
                    ser um código da listagem abaixo: [4210].
                ...
                idePartes: DeRe.EvtServRemTarifa.InfoOper.GOper.IdePartes = field(
                    metadata={
                        "type": "Element",
                    }
                )
                dadosOper: DeRe.EvtServRemTarifa.InfoOper.GOper.DadosOper = field(
                    metadata={
                        "type": "Element",
                    }
                )
                ...
                class IdePartes:
                    ...
                    infoAdq: DeRe.EvtServRemTarifa.InfoOper.GOper.IdePartes.InfoAdq = (
                        field(
                            metadata={
                                "type": "Element",
                            }
                    ...
                    class InfoAdq:
                        ...
                        adqExterior: (
                            None
                            | DeRe.EvtServRemTarifa.InfoOper.GOper.IdePartes.InfoAdq.AdqExterior
                        ) = field(
                            default=None,
                            metadata={
                                "type": "Element",
                ...
                class DadosOper:
                    ...
                    detOper: list[
                        DeRe.EvtServRemTarifa.InfoOper.GOper.DadosOper.DetOper
                    ] = field(
                        default_factory=list,
                        metadata={
                            "type": "Element",
                    ...
                    class DetOper:
                        ...
                        qualifOper: (
                            None
                            | DeRe.EvtServRemTarifa.InfoOper.GOper.DadosOper.DetOper.QualifOper
                        ) = field(
                            default=None,
                            metadata={
                                "type": "Element",
                        ...
                        gBC: DeRe.EvtServRemTarifa.InfoOper.GOper.DadosOper.DetOper.GBc = field(
                            metadata={
                                "type": "Element",
                            }
                        )
                        gTributos: DeRe.EvtServRemTarifa.InfoOper.GOper.DadosOper.DetOper.GTributos = field(
                            metadata={
                                "type": "Element",
                            }
                        )
                        ...
                        class QualifOper:
                            """
                            :ivar indPresenc: Indicador que define se o serviço
                                prestado foi fruído presencialmente por pessoa
                                física. Preenchimento: Obrigatório se {CPF} for
                                informado.
                            :ivar cMunOper: Código do município correspondente ao
                                local do estabelecimento onde o serviço foi
                                prestado, conforme tabela do IBGE. Preenchimento:
                                Obrigatório se {indPresenc} = [1]. Validação:
                                Deve ser um código existente na tabela de
                                municípios do IBGE.
                            """

                            indPresenc: None | QualifOperIndPresenc = field(
                                default=None,
                                metadata={
                                    "type": "Element",
                                    "white_space": "preserve",
                        ...
                        class GTributos:
                            ...
                            pIBSMunTrib: str = field(
                                metadata={
                                    ...
                                    "max_length": 8,
                                    "white_space": "preserve",
                                    "pattern": r"(0|[1-9][0-9]{0,2})\.[0-9]{2,4}",
                                }
                            )
