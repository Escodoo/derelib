...
__NAMESPACE__ = "http://www.dere.gov.br/schemas/evtAntecReceb/v0_0_1"
...
class QualifOperIndMoedaEstr(Enum):
    """
    :cvar VALUE_0: Não
    :cvar VALUE_1: Sim
    """
...
class DeRe(DereMixin):
    ...
    :ivar evtAntecReceb: Evento de identificação e detalhamento de operações de
        antecipação de recebíveis. Validação: Evento exclusivo e obrigatório para
        o registro de operações cujos códigos de base de cálculo ({codBC})
        correspondam a um dos seguintes valores: [1215; 1220; 1235; 1240; 2505;
    ...
    class Meta:
        name = "DeRE"
        namespace = "http://www.dere.gov.br/schemas/evtAntecReceb/v0_0_1"

    evtAntecReceb: DeRe.EvtAntecReceb = field(
        metadata={
            "type": "Element",
        }
    )
    ...
    class EvtAntecReceb:
        ...
        ideEvento: DeRe.EvtAntecReceb.IdeEvento = field(
            metadata={
                "type": "Element",
            }
        )
        ideContrib: DeRe.EvtAntecReceb.IdeContrib = field(
            metadata={
                "type": "Element",
            }
        )
        idePeriodo: DeRe.EvtAntecReceb.IdePeriodo = field(
            metadata={
                "type": "Element",
            }
        )
        infoOper: DeRe.EvtAntecReceb.InfoOper = field(
            metadata={
                "type": "Element",
            }
        )
        ...
        class InfoOper:
            ...
            gOper: list[DeRe.EvtAntecReceb.InfoOper.GOper] = field(
            ...
            class GOper:
                ...
                :ivar codBC: Código identificador da base de cálculo, conforme
                    ...
                    ser um código da listagem abaixo: [1215; 1220; 1235; 1240;
                    2505; 2510; 2515; 2520; 2525; 2530].
                ...
                idePartes: DeRe.EvtAntecReceb.InfoOper.GOper.IdePartes = field(
                    metadata={
                        "type": "Element",
                    }
                )
                dadosOper: DeRe.EvtAntecReceb.InfoOper.GOper.DadosOper = field(
                    metadata={
                        "type": "Element",
                    }
                )
                ...
                class IdePartes:
                    ...
                    infoAdq: DeRe.EvtAntecReceb.InfoOper.GOper.IdePartes.InfoAdq = (
                        field(
                            metadata={
                                "type": "Element",
                            }
                    ...
                    class InfoAdq:
                        ...
                        adqExterior: (
                            None
                            | DeRe.EvtAntecReceb.InfoOper.GOper.IdePartes.InfoAdq.AdqExterior
                        ) = field(
                            default=None,
                            metadata={
                                "type": "Element",
                ...
                class DadosOper:
                    ...
                    detOper: list[
                        DeRe.EvtAntecReceb.InfoOper.GOper.DadosOper.DetOper
                    ] = field(
                        default_factory=list,
                        metadata={
                            "type": "Element",
                    ...
                    class DetOper:
                        ...
                        qualifOper: (
                            None
                            | DeRe.EvtAntecReceb.InfoOper.GOper.DadosOper.DetOper.QualifOper
                        ) = field(
                            default=None,
                            metadata={
                                "type": "Element",
                        ...
                        gBC: DeRe.EvtAntecReceb.InfoOper.GOper.DadosOper.DetOper.GBc = (
                            field(
                                metadata={
                                    "type": "Element",
                                }
                        ...
                        gTributos: DeRe.EvtAntecReceb.InfoOper.GOper.DadosOper.DetOper.GTributos = field(
                            metadata={
                                "type": "Element",
                            }
                        )
                        ...
                        class QualifOper:
                            """
                            :ivar indMoedaEstr: Indicador de contrato
                                referenciado em moeda estrangeira.
                            """

                            indMoedaEstr: QualifOperIndMoedaEstr = field(
                                metadata={
                                    "type": "Element",
                                    "white_space": "preserve",
                                }
