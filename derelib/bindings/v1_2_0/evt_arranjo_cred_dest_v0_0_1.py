...
__NAMESPACE__ = "http://www.dere.gov.br/schemas/evtArranjoCredDest/v0_0_1"
...
class DeRe(DereMixin):
    ...
    :ivar evtArranjoCredDest: Evento de identificação e detalhamento de operações
        com identificação de credenciados ou destinatários dos serviços de
        arranjos de pagamento (estabelecimentos comerciais etc.). Validação:
    ...
    class Meta:
        name = "DeRE"
        namespace = "http://www.dere.gov.br/schemas/evtArranjoCredDest/v0_0_1"

    evtArranjoCredDest: DeRe.EvtArranjoCredDest = field(
        metadata={
            "type": "Element",
        }
    )
    ...
    class EvtArranjoCredDest:
        ...
        ideEvento: DeRe.EvtArranjoCredDest.IdeEvento = field(
            metadata={
                "type": "Element",
            }
        )
        ideContrib: DeRe.EvtArranjoCredDest.IdeContrib = field(
            metadata={
                "type": "Element",
            }
        )
        idePeriodo: DeRe.EvtArranjoCredDest.IdePeriodo = field(
            metadata={
                "type": "Element",
            }
        )
        infoOper: DeRe.EvtArranjoCredDest.InfoOper = field(
            metadata={
                "type": "Element",
            }
        )
        ...
        class InfoOper:
            ...
            gOper: list[DeRe.EvtArranjoCredDest.InfoOper.GOper] = field(
            ...
            class GOper:
                ...
                :ivar codBC: Código identificador da base de cálculo, conforme
                    ...
                    ser um código da listagem abaixo: [2405; 2410; 2415; 2420;
                    2425; 2430].
                ...
                idePartes: DeRe.EvtArranjoCredDest.InfoOper.GOper.IdePartes = field(
                    metadata={
                        "type": "Element",
                    }
                )
                dadosOper: DeRe.EvtArranjoCredDest.InfoOper.GOper.DadosOper = field(
                    metadata={
                        "type": "Element",
                    }
                )
                ...
                class IdePartes:
                    ...
                    infoAdq: DeRe.EvtArranjoCredDest.InfoOper.GOper.IdePartes.InfoAdq = field(
                        metadata={
                            "type": "Element",
                        }
                    )
                    ...
                    class InfoAdq:
                        ...
                        adqExterior: (
                            None
                            | DeRe.EvtArranjoCredDest.InfoOper.GOper.IdePartes.InfoAdq.AdqExterior
                        ) = field(
                            default=None,
                            metadata={
                                "type": "Element",
                ...
                class DadosOper:
                    ...
                    detOper: list[
                        DeRe.EvtArranjoCredDest.InfoOper.GOper.DadosOper.DetOper
                    ] = field(
                        default_factory=list,
                        metadata={
                            "type": "Element",
                    ...
                    class DetOper:
                        ...
                        gBC: DeRe.EvtArranjoCredDest.InfoOper.GOper.DadosOper.DetOper.GBc = field(
                            metadata={
                                "type": "Element",
                            }
                        )
                        gTributos: DeRe.EvtArranjoCredDest.InfoOper.GOper.DadosOper.DetOper.GTributos = field(
                            metadata={
                                "type": "Element",
                            }
                        )
                        ...
                        class GBc:
                            ...
                            gVOper: DeRe.EvtArranjoCredDest.InfoOper.GOper.DadosOper.DetOper.GBc.GVoper = field(
                                metadata={
                                    "type": "Element",
                                }
                            )
                            gDeducoes: (
                                None
                                | DeRe.EvtArranjoCredDest.InfoOper.GOper.DadosOper.DetOper.GBc.GDeducoes
                            ) = field(
                                default=None,
                                metadata={
                                    "type": "Element",
                            ...
                            detBC: DeRe.EvtArranjoCredDest.InfoOper.GOper.DadosOper.DetOper.GBc.DetBc = field(
                                metadata={
                                    "type": "Element",
                                }
                            )
