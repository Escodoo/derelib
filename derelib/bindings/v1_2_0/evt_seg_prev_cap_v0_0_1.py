...
__NAMESPACE__ = "http://www.dere.gov.br/schemas/evtSegPrevCap/v0_0_1"
...
class IdeEventoFinEvt(Enum):
    ...
    :cvar VALUE_21: Pagamento de dedução posterior ao recebimento da receita
...
class IdePartesIndIdentifAdq(Enum):
    """
    :cvar VALUE_0: Subscritor não obrigado a se identificar
    :cvar VALUE_1: Subscritor obrigado a se identificar
    """
...
class DeRe(DereMixin):
    ...
    :ivar evtSegPrevCap: Evento de identificação e detalhamento de operações de
        seguros, previdência e capitalização. Validação: Evento exclusivo e
        obrigatório para o registro de operações cujos códigos de base de cálculo
        ({codBC}) correspondam a um dos seguintes valores: [3005; 3010; 3015;
        3020; 3025; 3030; 3405; 3410].
    :ivar signature:
    """

    class Meta:
        name = "DeRE"
        namespace = "http://www.dere.gov.br/schemas/evtSegPrevCap/v0_0_1"

    evtSegPrevCap: DeRe.EvtSegPrevCap = field(
        metadata={
            "type": "Element",
        }
    )
    ...
    class EvtSegPrevCap:
        ...
        ideEvento: DeRe.EvtSegPrevCap.IdeEvento = field(
            metadata={
                "type": "Element",
            }
        )
        ideContrib: DeRe.EvtSegPrevCap.IdeContrib = field(
            metadata={
                "type": "Element",
            }
        )
        idePeriodo: DeRe.EvtSegPrevCap.IdePeriodo = field(
            metadata={
                "type": "Element",
            }
        )
        infoOper: DeRe.EvtSegPrevCap.InfoOper = field(
            metadata={
                "type": "Element",
            }
        )
        ...
        class InfoOper:
            ...
            gOper: list[DeRe.EvtSegPrevCap.InfoOper.GOper] = field(
            ...
            class GOper:
                ...
                :ivar codBC: Código identificador da base de cálculo, conforme
                    ...
                    ser um código da listagem abaixo: [3005; 3010; 3015; 3020;
                    3025; 3030; 3405; 3410].
                ...
                idePartes: DeRe.EvtSegPrevCap.InfoOper.GOper.IdePartes = field(
                    metadata={
                        "type": "Element",
                    }
                )
                dadosOper: DeRe.EvtSegPrevCap.InfoOper.GOper.DadosOper = field(
                    metadata={
                        "type": "Element",
                    }
                )
                ...
                class IdePartes:
                    """
                    :ivar indIdentifAdq: Indicador se o subscritor é obrigado a
                        se identificar por ocasião da aquisição, nos termos de
                        norma do órgão regulador competente. Nota: Campo
                        exclusivo para operações de capitalização. Preenchimento:
                        Exclusivo e obrigatório se {codBC} = [3405; 3410].
                    :ivar infoAdq: Informações de identificação do adquirente.
                        Preenchimento: Opcional se {codBC} = [3005; 3010] E
                        {indIdentifAdq} = [0]. Obrigatório nos demais casos.
                    :ivar infoPDV: Informações do ponto de venda. Preenchimento:
                        Exclusivo e obrigatório quando o grupo {infoAdq} não for
                        informado.
                    """

                    indIdentifAdq: None | IdePartesIndIdentifAdq = field(
                        default=None,
                        metadata={
                            "type": "Element",
                            "white_space": "preserve",
                    ...
                    infoAdq: (
                        None | DeRe.EvtSegPrevCap.InfoOper.GOper.IdePartes.InfoAdq
                    ) = field(
                        default=None,
                        metadata={
                            "type": "Element",
                    ...
                    infoPDV: (
                        None | DeRe.EvtSegPrevCap.InfoOper.GOper.IdePartes.InfoPdv
                    ) = field(
                        default=None,
                        metadata={
                            "type": "Element",
                    ...
                    class InfoAdq:
                        ...
                        adqExterior: (
                            None
                            | DeRe.EvtSegPrevCap.InfoOper.GOper.IdePartes.InfoAdq.AdqExterior
                        ) = field(
                            default=None,
                            metadata={
                                "type": "Element",
                ...
                class DadosOper:
                    ...
                    detOper: list[
                        DeRe.EvtSegPrevCap.InfoOper.GOper.DadosOper.DetOper
                    ] = field(
                        default_factory=list,
                        metadata={
                            "type": "Element",
                    ...
                    class DetOper:
                        ...
                        :ivar dhOper: Data e hora da operação (UTC). Máscara:
                            ...
                            evento.
                        :ivar gSemCobSobr: Grupo de informações de seguros de
                            ramos elementares e seguros de pessoas sem cobertura
                            por sobrevivência. Preenchimento: Exclusivo e
                            obrigatório se {codBC} = [3005; 3010; 3015; 3020].
                        :ivar gCobSobrPrevComp: Grupo de informações de seguros
                            de pessoas com cobertura por sobrevivência e
                            previdência complementar. Preenchimento: Exclusivo e
                            obrigatório se {codBC} = [3025; 3030].
                        :ivar gCapitalizacao: Identificação de operações de
                            capitalização. Preenchimento: Exclusivo e obrigatório
                            se {codBC} = [3405; 3410].
                        :ivar gTributos: Grupo de totalização de tributos
                            incidentes sobre a operação. Preenchimento: Exclusivo
                            e obrigatório se {codBC} = [3005; 3010].
                        ...
                        gSemCobSobr: (
                            None
                            | DeRe.EvtSegPrevCap.InfoOper.GOper.DadosOper.DetOper.GSemCobSobr
                        ) = field(
                            default=None,
                            metadata={
                                "type": "Element",
                        ...
                        gCobSobrPrevComp: (
                            None
                            | DeRe.EvtSegPrevCap.InfoOper.GOper.DadosOper.DetOper.GCobSobrPrevComp
                        ) = field(
                            default=None,
                            metadata={
                                "type": "Element",
                        ...
                        gCapitalizacao: (
                            None
                            | DeRe.EvtSegPrevCap.InfoOper.GOper.DadosOper.DetOper.GCapitalizacao
                        ) = field(
                            default=None,
                            metadata={
                                "type": "Element",
                        ...
                        gTributos: (
                            None
                            | DeRe.EvtSegPrevCap.InfoOper.GOper.DadosOper.DetOper.GTributos
                        ) = field(
                            default=None,
                            metadata={
                                "type": "Element",
                        ...
                        class GSemCobSobr:
                            """
                            :ivar vPremioReceb: Valor total do prêmio recebido.
                                Preenchimento: Exclusivo e obrigatório se {codBC}
                                = [3015; 3020].
                            :ivar vBCApur: Valor da base de cálculo líquida
                                ...
                                se aplicável. Preenchimento: Exclusivo e
                                obrigatório se {codBC} = [3005; 3010].
                            """

                            vPremioReceb: None | str = field(
                                default=None,
                                metadata={
                                    "type": "Element",
                                    "min_length": 4,
                        ...
                        @dataclass(kw_only=True)
                        class GCobSobrPrevComp:
                            """
                            :ivar vBCDistr: Valor da base de cálculo aferida na
                                operação para fins de distribuição do IBS.
                                Corresponde ao valor da soma: 1. das
                                contribuições ou prêmios para a entidade de
                                previdência complementar ou seguradora, deduzida
                                da parcela destinada à constituição de provisões
                                ou reservas técnicas; e 2. dos encargos do fundo
                                decorrentes da estruturação e da manutenção de
                                planos de previdência e seguro de pessoas com
                        ...
                        @dataclass(kw_only=True)
                        class GCapitalizacao:
                            """
                            :ivar vOper: Valor arrecadado com a venda do título
                                de capitalização.
                            :ivar cMunOper: Identificação do Município
                                correspondente ao local de comercialização do
                                título de capitalização. Código do município do
                                IBGE. Preenchimento: Exclusivo e obrigatório se
                                {indIdentifAdq} = [0] (Subscritor não obrigado a
                                se identificar).
                            """
