...
__NAMESPACE__ = "http://www.dere.gov.br/schemas/evtRetornoRDed/v0_0_1"
...
class DeRe(DereMixin):
    ...
    :ivar evtRetornoRDed: Retorno do evento Relação de Deduções Utilizadas na
        Apuração.
    :ivar signature:
    """
    ...
    class Meta:
        name = "DeRE"
        namespace = "http://www.dere.gov.br/schemas/evtRetornoRDed/v0_0_1"

    evtRetornoRDed: DeRe.EvtRetornoRded = field(
        metadata={
            "type": "Element",
        }
    )
    ...
    class EvtRetornoRded:
        ...
        ideContrib: DeRe.EvtRetornoRded.IdeContrib = field(
            metadata={
                "type": "Element",
            }
        )
        ideStatus: DeRe.EvtRetornoRded.IdeStatus = field(
            metadata={
                "type": "Element",
            }
        )
        infoRecEv: DeRe.EvtRetornoRded.InfoRecEv = field(
            metadata={
                "type": "Element",
            }
        )
        infoEvento: None | DeRe.EvtRetornoRded.InfoEvento = field(
            default=None,
            metadata={
                "type": "Element",
            },
        ...
        class IdeStatus:
            ...
            ocorrencias: list[DeRe.EvtRetornoRded.IdeStatus.Ocorrencias] = field(
        ...
        class InfoEvento:
            ...
            idePeriodo: DeRe.EvtRetornoRded.InfoEvento.IdePeriodo = field(
                metadata={
                    "type": "Element",
                }
            )
            infoAdic: None | DeRe.EvtRetornoRded.InfoEvento.InfoAdic = field(
                default=None,
                metadata={
                    "type": "Element",
                },
