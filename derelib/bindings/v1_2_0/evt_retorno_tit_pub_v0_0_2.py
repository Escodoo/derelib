...
__NAMESPACE__ = "http://www.dere.gov.br/schemas/evtRetornoTitPub/v0_0_2"
...
class DeRe(DereMixin):
    ...
    :ivar evtRetornoTitPub: Retorno do evento Débito em Operações com Títulos de
    ...
    class Meta:
        name = "DeRE"
        namespace = "http://www.dere.gov.br/schemas/evtRetornoTitPub/v0_0_2"

    evtRetornoTitPub: DeRe.EvtRetornoTitPub = field(
        metadata={
            "type": "Element",
        }
    )
    ...
    class EvtRetornoTitPub:
        ...
        ideContrib: DeRe.EvtRetornoTitPub.IdeContrib = field(
            metadata={
                "type": "Element",
            }
        )
        ideStatus: DeRe.EvtRetornoTitPub.IdeStatus = field(
            metadata={
                "type": "Element",
            }
        )
        infoRecEv: DeRe.EvtRetornoTitPub.InfoRecEv = field(
            metadata={
                "type": "Element",
            }
        )
        infoEvento: None | DeRe.EvtRetornoTitPub.InfoEvento = field(
            default=None,
            metadata={
                "type": "Element",
            },
        ...
        class IdeStatus:
            ...
            ocorrencias: list[DeRe.EvtRetornoTitPub.IdeStatus.Ocorrencias] = field(
        ...
        class InfoEvento:
            ...
            :ivar infoTotTitOfPub: Informações de totalizadores do evento D-2101
                - Débito em Operações com Títulos de Dívida com Oferta Pública
                {evtDebOpOferPublica}.
            """

            idePeriodo: DeRe.EvtRetornoTitPub.InfoEvento.IdePeriodo = field(
                metadata={
                    "type": "Element",
                }
            )
            infoAdic: None | DeRe.EvtRetornoTitPub.InfoEvento.InfoAdic = field(
                default=None,
                metadata={
                    "type": "Element",
                },
            )
            infoTotTitOfPub: None | DeRe.EvtRetornoTitPub.InfoEvento.InfoTotTitOfPub = (
                field(
                    default=None,
                    metadata={
                        "type": "Element",
            ...
            @dataclass(kw_only=True)
            class InfoTotTitOfPub:
                """
                :ivar vApurTot: Somatório de todas as ocorrências de {vApur} do
                    evento D-2101 ({evtDebOpOferPublica}). Cálculo: SOMA({vApur})
                """
