...
__NAMESPACE__ = "http://www.dere.gov.br/schemas/evtOperFinanc/v0_0_1"
...
class DeRe(DereMixin):
    ...
    :ivar evtOperFinanc: Evento de identificação e detalhamento de operações de
        crédito e TVM. Validação: Evento exclusivo e obrigatório para o registro
        de operações cujos códigos de base de cálculo ({codBC}) correspondam a um
        dos seguintes valores: [1005; 1010; 2220].
    :ivar signature:
    """

    class Meta:
        name = "DeRE"
        namespace = "http://www.dere.gov.br/schemas/evtOperFinanc/v0_0_1"

    evtOperFinanc: DeRe.EvtOperFinanc = field(
        metadata={
            "type": "Element",
        }
    )
    ...
    class EvtOperFinanc:
        ...
        ideEvento: DeRe.EvtOperFinanc.IdeEvento = field(
            metadata={
                "type": "Element",
            }
        )
        ideContrib: DeRe.EvtOperFinanc.IdeContrib = field(
            metadata={
                "type": "Element",
            }
        )
        idePeriodo: DeRe.EvtOperFinanc.IdePeriodo = field(
            metadata={
                "type": "Element",
            }
        )
        infoOper: DeRe.EvtOperFinanc.InfoOper = field(
            metadata={
                "type": "Element",
            }
        )
        ...
        class InfoOper:
            ...
            gOper: list[DeRe.EvtOperFinanc.InfoOper.GOper] = field(
            ...
            class GOper:
                ...
                :ivar codBC: Código identificador da base de cálculo, conforme
                    ...
                    ser um código da listagem abaixo: [1005; 1010; 2220].
                ...
                idePartes: DeRe.EvtOperFinanc.InfoOper.GOper.IdePartes = field(
                    metadata={
                        "type": "Element",
                    }
                )
                dadosOper: DeRe.EvtOperFinanc.InfoOper.GOper.DadosOper = field(
                    metadata={
                        "type": "Element",
                    }
                )
                ...
                class IdePartes:
                    ...
                    infoAdq: DeRe.EvtOperFinanc.InfoOper.GOper.IdePartes.InfoAdq = (
                        field(
                            metadata={
                                "type": "Element",
                            }
                    ...
                    class InfoAdq:
                        ...
                        adqExterior: (
                            None
                            | DeRe.EvtOperFinanc.InfoOper.GOper.IdePartes.InfoAdq.AdqExterior
                        ) = field(
                            default=None,
                            metadata={
                                "type": "Element",
                ...
                class DadosOper:
                    ...
                    detOper: list[
                        DeRe.EvtOperFinanc.InfoOper.GOper.DadosOper.DetOper
                    ] = field(
                        default_factory=list,
                        metadata={
                            "type": "Element",
                    ...
                    class DetOper:
                        ...
                        qualifOper: DeRe.EvtOperFinanc.InfoOper.GOper.DadosOper.DetOper.QualifOper = field(
                            metadata={
                                "type": "Element",
                            }
                        )
                        gBC: DeRe.EvtOperFinanc.InfoOper.GOper.DadosOper.DetOper.GBc = (
                            field(
                                metadata={
                                    "type": "Element",
                                }
                        ...
                        gTributos: DeRe.EvtOperFinanc.InfoOper.GOper.DadosOper.DetOper.GTributos = field(
                            metadata={
                                "type": "Element",
                            }
                        )
