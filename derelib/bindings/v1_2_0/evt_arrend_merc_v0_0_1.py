...
__NAMESPACE__ = "http://www.dere.gov.br/schemas/evtArrendMerc/v0_0_1"
...
class DeRe(DereMixin):
    ...
    :ivar evtArrendMerc: Evento de identificação e detalhamento das operações de
        arrendamento mercantil. Validação: Evento exclusivo e obrigatório para o
        registro de operações cujos códigos de base de cálculo ({codBC})
        correspondam a um dos seguintes valores: [1410; 1420; 1430; 1440; 1450;
        1460; 1470; 1480; 1605; 1610; 1615; 1620; 1630; 1640].
    :ivar signature:
    """

    class Meta:
        name = "DeRE"
        namespace = "http://www.dere.gov.br/schemas/evtArrendMerc/v0_0_1"

    evtArrendMerc: DeRe.EvtArrendMerc = field(
        metadata={
            "type": "Element",
        }
    )
    ...
    class EvtArrendMerc:
        ...
        ideEvento: DeRe.EvtArrendMerc.IdeEvento = field(
            metadata={
                "type": "Element",
            }
        )
        ideContrib: DeRe.EvtArrendMerc.IdeContrib = field(
            metadata={
                "type": "Element",
            }
        )
        idePeriodo: DeRe.EvtArrendMerc.IdePeriodo = field(
            metadata={
                "type": "Element",
            }
        )
        infoOper: DeRe.EvtArrendMerc.InfoOper = field(
            metadata={
                "type": "Element",
            }
        )
        ...
        class InfoOper:
            ...
            gOper: list[DeRe.EvtArrendMerc.InfoOper.GOper] = field(
            ...
            class GOper:
                ...
                :ivar codBC: Código identificador da base de cálculo, conforme
                    ...
                    ser um código da listagem abaixo: [1410; 1420; 1430; 1440;
                    1450; 1460; 1470; 1480; 1605; 1610; 1615; 1620; 1630; 1640].
                ...
                idePartes: DeRe.EvtArrendMerc.InfoOper.GOper.IdePartes = field(
                    metadata={
                        "type": "Element",
                    }
                )
                dadosOper: DeRe.EvtArrendMerc.InfoOper.GOper.DadosOper = field(
                    metadata={
                        "type": "Element",
                    }
                )
                ...
                class IdePartes:
                    ...
                    infoAdq: DeRe.EvtArrendMerc.InfoOper.GOper.IdePartes.InfoAdq = (
                        field(
                            metadata={
                                "type": "Element",
                            }
                    ...
                    class InfoAdq:
                        ...
                        adqExterior: (
                            None
                            | DeRe.EvtArrendMerc.InfoOper.GOper.IdePartes.InfoAdq.AdqExterior
                        ) = field(
                            default=None,
                            metadata={
                                "type": "Element",
                ...
                class DadosOper:
                    ...
                    detOper: list[
                        DeRe.EvtArrendMerc.InfoOper.GOper.DadosOper.DetOper
                    ] = field(
                        default_factory=list,
                        metadata={
                            "type": "Element",
                    ...
                    class DetOper:
                        ...
                        :ivar gTributos: Grupo de totalização de tributos
                            ...
                            e obrigatório se {codBC} = [1410; 1420; 1430; 1440;
                            1450; 1460; 1470; 1480; 1605; 1610; 1630; 1640].
                        ...
                        gBC: DeRe.EvtArrendMerc.InfoOper.GOper.DadosOper.DetOper.GBc = (
                            field(
                                metadata={
                                    "type": "Element",
                                }
                        ...
                        gTributos: (
                            None
                            | DeRe.EvtArrendMerc.InfoOper.GOper.DadosOper.DetOper.GTributos
                        ) = field(
                            default=None,
                            metadata={
                                "type": "Element",
                        ...
                        class GBc:
                            """
                            :ivar vOper: Valor da parcela recebida pelo
                                arrendamento mercantil financeiro, incluindo o
                                valor de tarifa vinculada ao contrato.
                            ...
                            :ivar vBCApur: Valor da base de cálculo líquida
                                ...
                                obrigatório se {codBC} = [1410; 1420; 1430; 1440;
                                1450; 1460; 1470; 1480; 1605; 1610; 1630; 1640].
                            """

                            vOper: None | str = field(
                                default=None,
                                metadata={
                                    "type": "Element",
                                    "min_length": 4,
